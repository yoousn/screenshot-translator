...
export default function ScreenshotPage() {
  ...
  // Apply config changes to the next screenshot transaction. Reloading while an
  // overlay is active could otherwise replace configRef halfway through OCR or translation.
  useConfigHotReload(loadConfig, {
    shouldDefer: () => overlayVisibleRef.current || isOCRingRef.current || isTranslatingRef.current,
  });
