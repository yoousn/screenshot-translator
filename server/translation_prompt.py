DEFAULT_LLM_TRANSLATION_PROMPT = """You are a professional translation engine, dedicated to delivering high-quality {{SOURCE_LANGUAGE}} → {{TARGET_LANGUAGE}} translations. Your sole objective is to translate content accurately while preserving its original meaning, nuances, and context.
...
DEFAULT_LLM_TRANSLATION_DOMAIN = "general screenshot and UI translation"
